...
export default function SolutionsGrid() {
 ...
 {
 key: "audit",
 icon: <Search className="w-8 h-8 text-ember" />,
 action: () => setIsRadarOpen(true),
 highlight: false
 },
 {
 key: "noshow",
 icon: <ShieldCheck className="w-8 h-8 text-ember" />,
 action: () => document.getElementById("shield-calculator")?.scrollIntoView({ behavior: "smooth" }),
 highlight: false
 },
 {
 key: "efficiency",
 icon: <BarChart3 className="w-8 h-8 text-ember" />,
 ...
 return (
 <section id="soluciones" className="py-20 md:py-32 bg-cream relative overflow-hidden">
 ...
 <span className="text-ember font-mono text-sm uppercase mb-4 md:mb-6 block tracking-widest">
 {t("badge")}
 </span>
 ...
 <TiltCard
 key={idx}
 className={`rounded-[2rem] bg-surface border ${product.highlight ? 'border-ember/20' : 'border-white/5'} relative overflow-hidden group p-6 md:p-8 lg:p-8 h-full flex flex-col`}
 ...
 {/* Left Content */}
 <div>
 <div className="w-14 h-14 md:w-16 md:h-16 lg:w-12 lg:h-12 rounded-2xl bg-ember/10 flex items-center justify-center mb-6 md:mb-8 lg:mb-6 border border-ember/20">
 {product.icon}
 </div>
 <h3 className="text-2xl md:text-4xl lg:text-2xl font-black text-white mb-3 md:mb-4 tracking-tight font-display">
 {t(`${product.key}.title`)}
 </h3>
 <p className="text-lg md:text-xl lg:text-base text-ember font-mono mb-6">
 ...
 className="w-full bg-white/5 border border-white/10 text-white font-bold py-4 rounded-xl hover:bg-white hover:text-ink transition-all uppercase tracking-widest text-xs"
 >
 {t(`${product.key}.cta`)}
 </button>
 ...
 className="w-full flex items-center justify-center gap-2 text-ember font-bold text-[10px] uppercase tracking-widest hover:text-white transition-colors"
 >
 ...
 <TiltCard
 className="w-full bg-ember rounded-[2rem] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 group relative overflow-hidden"
 glowColor="#ffffff"
 >
 <div className="max-w-md relative z-10">
 <h3 className="text-3xl md:text-4xl font-black text-ink mb-4 tracking-tight leading-[0.9] font-display">
 {t("results.title")}
 </h3>
 <p className="text-ink-mid font-bold font-mono tracking-tight">
 {t("results.subtitle")}
 </p>
 </div>
 ...
 className="block font-mono font-black text-5xl md:text-6xl text-ink tracking-tighter"
 >
 {t("results.revenue.value")}
 </motion.span>
 <span className="text-xs font-black uppercase text-ink-mid tracking-widest">
