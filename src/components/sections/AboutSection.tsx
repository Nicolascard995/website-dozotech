...
export default function AboutSection() {
    ...
    return (
        <section className="py-32 bg-obsidian overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center relative z-10">
                <div className="relative order-2 md:order-1 perspective-1000" ref={containerRef}>
                    <TiltCard className="rounded-3xl">
                        ...
                        >
                            ...
                            <div className="absolute inset-0 backface-hidden rounded-3xl overflow-hidden" style={{ backfaceVisibility: 'hidden', zIndex: 2 }}>
                                <div className="absolute inset-0 bg-acid-lime/10 mix-blend-overlay z-20 pointer-events-none"></div>
                                <img
                                    src="/images/chef_profile.png"
                                    alt="The Chef"
                                    className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500"
                                />
                                <div className="absolute bottom-6 left-6 right-6 p-6 glass-panel rounded-2xl border border-white/5 z-30">
                            ...
                            >
                                <div className="absolute inset-0 bg-acid-lime/5 mix-blend-overlay z-20 pointer-events-none"></div>
                                <img
                    ...
                    {/* Neon Pulse Badge */}
                    <div className="absolute -top-6 -right-6 w-32 h-32 glass rounded-full flex items-center justify-center border border-acid-lime/30 z-30 shadow-[0_0_30px_rgba(212,255,0,0.2)]">
                        <div className="absolute inset-0 rounded-full border border-acid-lime/50 animate-ping opacity-20"></div>
                        <div className="text-center relative">
                            <span className="block text-acid-lime font-mono font-bold text-4xl neon-text">5</span>
                ...
                <div className="order-1 md:order-2">
                    <span className="text-acid-lime font-mono text-sm tracking-widest uppercase mb-4 block neon-text">{t('badge')}</span>
                    ...
                    <div className="space-y-6 text-slate-400 text-lg font-light leading-relaxed font-sans">
                        ...
                        <p className="border-l-4 border-acid-lime pl-6 italic text-white/90 text-xl font-display">
                            {t('quote')}
                        </p>
