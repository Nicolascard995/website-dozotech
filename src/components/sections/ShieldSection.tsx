...
export default function ShieldSection() {
 return (
 <section id="shield-calculator" className="py-24 bg-cream relative overflow-hidden">
 {/* Background Elements */}
 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-ink/5 rounded-full blur-[120px] pointer-events-none" />
 ...
 <span className="text-ember font-mono text-sm uppercase tracking-widest">
 No-Show Killer
 </span>
 <h2 className="text-4xl md:text-6xl font-black text-white tracking-tighter decoration-clone leading-tight font-display">
 Protect your <span className="text-ember">revenue</span>.
 </h2>
