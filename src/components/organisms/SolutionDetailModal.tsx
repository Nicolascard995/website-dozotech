...
export default function SolutionDetailModal({ isOpen, onClose, productKey, onAction }: SolutionDetailModalProps) {
 ...
 <p className="text-xl text-ember font-mono mb-8">
 ...
 <button
 onClick={onAction}
 className="w-full bg-ember text-ink font-black py-5 rounded-2xl hover:bg-white transition-all uppercase tracking-widest flex items-center justify-center gap-3"
 >
 {t(`${productKey}.cta`)}
 <ArrowRight className="w-5 h-5" />
 </button>
 <p className="text-center text-ember/60 text-sm font-mono font-bold">
 {t(`${productKey}.result`)}
 </p>
 </div>
 </div>
