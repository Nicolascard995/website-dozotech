                ...
                <AnimatePresence mode="wait">
                    {step === "input" && (
                        ...
                        >
                            ...
                            <button
                                type="submit"
                                className="w-full bg-cyan text-obsidian font-bold py-3 rounded-lg hover:bg-cyan/90 transition-all uppercase tracking-wide mt-4"
                            >
                                {t("action_calculate")}
                            </button>
                        </motion.form>
                    ...
                    {step === "result" && annualLoss !== null && (
                        ...
                        >
                            ...
                            <div className="p-4 bg-white/5 rounded-xl border border-white/10">
                                <p className="text-cyan font-bold mb-1">{t("upgrade_title")}</p>
                                <p className="text-white/70 text-sm mb-4">
                                    {t("upgrade_desc")}
                                </p>
                                <button
                                    onClick={() => setStep("email")}
                                    className="w-full border border-cyan text-cyan font-bold py-2 rounded-lg hover:bg-cyan hover:text-obsidian transition-all uppercase text-sm"
                                >
                                    {t("action_unlock")}
                                </button>
                            </div>
