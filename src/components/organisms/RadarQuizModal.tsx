                ...
                <div className="p-8 md:p-10 relative z-10 min-h-[400px] flex flex-col justify-center">
                    <AnimatePresence mode="wait">
                        ...
                        {step === 0 && (
                            ...
                            >
                                <div className="w-16 h-16 rounded-full bg-cyan/10 flex items-center justify-center mx-auto border border-cyan/20">
                                    <EyeOff className="w-8 h-8 text-cyan" />
                                </div>
                                ...
                                <button
                                    onClick={() => setStep(1)}
                                    className="w-full bg-cyan text-obsidian font-bold py-4 rounded-xl hover:bg-cyan/90 transition-all uppercase tracking-wide flex items-center justify-center gap-2"
                                >
                        ...
                        {step > 0 && step <= questions.length && (
                            <motion.div
                                ...
                                className="space-y-8"
                            >
                                <div className="flex justify-between items-center text-xs font-mono text-cyan/60 uppercase tracking-widest">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <button
                                        ...
                                        className="py-4 rounded-xl border border-white/10 hover:bg-cyan/10 hover:border-cyan/50 hover:text-cyan text-white transition-all font-bold uppercase"
                                    >
                                        {t("btn_yes")}
                                    </button>
                                </div>
                            ...
                            >
                                ...
                                <form onSubmit={handleEmailSubmit} className="space-y-4">
                                    <input
                                        ...
                                        className="w-full bg-black/20 border border-white/10 rounded-xl px-4 py-4 text-white placeholder-white/30 focus:border-cyan focus:outline-none transition-colors text-center"
                                        value={name}
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-white text-obsidian font-bold py-4 rounded-xl hover:bg-slate-200 transition-all uppercase tracking-wide"
                                    >
                                        {t("gate_btn")}
                                    </button>
                                </form>
                        ...
                        {step === 100 && (
                            <motion.div
                                ...
                                className="text-center space-y-6"
                            >
                                <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto border-4 ${resultTier === 'visible' ? 'bg-cyan/10 border-cyan text-cyan' :
                                ...
                                <div>
                                    ...
                                    <h2 className={`text-4xl font-black font-display uppercase ${resultTier === 'visible' ? 'text-cyan' :
                                ...
                                <button
                                    ...
                                    className={`w-full font-bold py-4 rounded-xl text-obsidian uppercase tracking-wide transition-all ${resultTier === 'visible' ? 'bg-cyan hover:bg-cyan/90' :
